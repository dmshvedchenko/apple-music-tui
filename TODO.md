...
- [x] Give user commands and open-playlist continuation precedence over the background library scan; live-measure small, medium/fallback, and large playlist loading.
